...
check:
	...
	do \
	  ...
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c csvreader.c sbuf.c varstr.c $(LDFLAGS) ) \
	  && ( t/a.out ); \
	done 
...
check-examples:
	...
	do \
	  ...
	  ( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out $$i.c csvreader.c sbuf.c varstr.c $(LDFLAGS) ) \
...
echeck:
	...
	do \
	  ...
	  echo "Running test $$i ..."; \
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c csvreader.c sbuf.c varstr.c $(LDFLAGS_EFENCE) ) \
